        ...
        compression_state *comp)
{
   ...
   png_ptr->zstream.avail_in = (unsigned)text_len;
   ...
   {
      /* Compress the data */
	   ret = deflate(&png_ptr->zstream, ZLib::Z_NO_FLUSH);
      if (ret != ZLib::Z_OK)
      {
         /* Error */
   ...
   do
   {
      ...
      ret = deflate(&png_ptr->zstream, ZLib::Z_FINISH);
   ...
   int interlace_type)
{
   ...
   if (!(png_ptr->flags & PNG_FLAG_ZLIB_CUSTOM_LEVEL))
      png_ptr->zlib_level = ZLib::Z_DEFAULT_COMPRESSION;
