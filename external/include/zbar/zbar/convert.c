                                ...
                                const zbar_format_def_t *srcfmt)
{
    ...
    memset((unsigned char*)dst->data + n, 0x80, dst->datalen - n);
}
                              ...
                              const zbar_format_def_t *srcfmt)
{
    ...
    if(flags & 1) {
        srcv = (unsigned char*)src->data + srcn;
        srcu = srcv + srcm;
    } else {
        srcu = (unsigned char*)src->data + srcn;
        srcv = srcu + srcm;
    }
                                ...
                                const zbar_format_def_t *srcfmt)
{
    ...
    if(!dst->data) return;
    if(dstm2)
        memset((unsigned char*)dst->data + dstn, 0x80, dstm2);
...
{
	return 0;
	// snip... removing all video output!
